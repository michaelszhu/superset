...
> **Automated Security Remediation Demo**
>
> This fork contains open **Issues** and **Pull Requests** generated by an automated remediation pipeline (powered by Devin).
> They are intentionally left open to demonstrate the end-to-end workflow.
> See [`REMEDIATION.md`](REMEDIATION.md) for a full summary of the 8 selected findings and their outcomes.
